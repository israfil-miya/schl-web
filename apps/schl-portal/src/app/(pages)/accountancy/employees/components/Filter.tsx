...
const FilterButton: React.FC<PropsType> = props => {
  ...
  const serviceTimeOptions = [
    ...
    { value: 'atLeast1Year', label: 'At least 1 year' },
    { value: 'atLeast2Years', label: 'At least 2 years' },
    { value: 'atLeast3Years', label: 'At least 3 years' },
    { value: 'moreThan3Years', label: 'More than 3 years' },
  ];
            ...
            <div className="grid grid-cols-1 gap-x-3 gap-y-4 mb-4">
                ...
                <Select
                  ...
                  value={
                    bloodGroupOptions.find(
                      option => option.value === filters.bloodGroup,
                    ) || null
                  }
              ...
              <div>
                ...
                <Select
                  ...
                  styles={setCalculatedZIndex(baseZIndex)}
                  value={
                    serviceTimeOptions.find(
                      option => option.value === filters.serviceTime,
                    ) || null
                  }
                  onChange={selectedOption =>
                    setFilters((prevFilters: PropsType['filters']) => ({
                      ...prevFilters,
                      serviceTime: selectedOption?.value || '',
                    }))
                  }
