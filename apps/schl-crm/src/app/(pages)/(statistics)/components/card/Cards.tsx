    ...
    return (
        <div className="sm:flex grid grid-cols-2 gap-4 mb-4 justify-between px-2">
            <Card
                ...
                onClick={() =>
                    router.push(
                        process.env.NEXT_PUBLIC_BASE_URL + '/trial-clients',
                    )
                }
                icon={
                    <svg
            ...
            <Card
                ...
                onClick={() =>
                    router.push(
                        process.env.NEXT_PUBLIC_BASE_URL + '/stale-clients',
                    )
                }
                icon={
                    <svg
            ...
            <Card
                ...
                onClick={() =>
                    router.push(
                        process.env.NEXT_PUBLIC_BASE_URL + '/ideal-prospects',
                    )
                }
                icon={
                    <svg
            ...
            <Card
                ...
                onClick={() =>
                    router.push(
                        process.env.NEXT_PUBLIC_BASE_URL + '/regular-clients',
                    )
                }
                icon={
                    <svg
