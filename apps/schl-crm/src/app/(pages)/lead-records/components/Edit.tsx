                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <span className="cursor-pointer has-tooltip">
                                        &#9432;
                                        <span className="tooltip italic font-medium rounded-md text-xs shadow-lg p-1 px-2 bg-gray-100 ml-2">
                                            Transfer lead to another marketer
                                        </span>
                                    </span>
                                </label>
                                <select
                                    value={editedData.marketer_name}
                                    onChange={e =>
                                        setEditedData(prevData => ({
                                            ...prevData,
                                    ...
                                    className="appearance-none block w-full bg-gray-50 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                >
                                    {props.marketerNames.map(marketer => (
                                ...
                                {editedData.is_prospected && (
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="high_interest">
                                                High Interest
                                            </option>
                                            <option value="low_interest">
                                                Low Interest
                                            </option>
                                        </select>
                                    </div>
                ...
                <label htmlFor="test-job-checkbox" className="uppercase ">
                  Test Job
                            ...
                            <div className="flex gap-2 items-center">
                                ...
                                />
                                <label
                                    htmlFor="followup-done-checkbox"
                                    className="uppercase "
                                >
                                    Followup Pending
                                </label>
                    ...
                    <footer className="flex items-center px-4 py-2 border-t justify-between gap-6 border-gray-200 rounded-b">
                        <div className="text-md flex flex-col items-start">
                            ...
                            {props.leadData.lead_origin &&
                                props.leadData.lead_origin !== 'generated' && (
                                    <p>
                                        <span className="underline">
                                            Transferred from:
                                        </span>{' '}
