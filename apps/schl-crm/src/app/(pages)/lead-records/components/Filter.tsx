...
interface PropsType {
    ...
    filters: {
        ...
        leadOrigin: 'generated' | 'transferred';
                        ...
                        <div className="regular-search">
                            ...
                            <div className="checkboxes flex flex-col sm:flex-row gap-4 my-4">
                                ...
                                <div className="flex gap-2 items-center">
                                    <input
                                        name="freshLead"
                                        checked={filters.freshLead}
                                        onChange={handleChange}
                                        id="freshLead-checkbox"
                                        type="checkbox"
                                        className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                                    />
                                    <label
                                        htmlFor="freshLead-checkbox"
                                        className="uppercase "
                                    >
                                        Fresh
                                    </label>
                                ...
                                <div className="radios flex flex-col sm:flex-row gap-1 sm:gap-4">
                                    <div className="flex gap-2 items-center">
                                        <input
                                            ...
                                            onChange={handleChange}
                                            id="origin-generated-radio"
                                            value="generated"
                                            type="radio"
                                            className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2"
                                        />
                                        <label
                                            htmlFor="origin-generated-radio"
                                            className="uppercase"
                                        >
                                            Generated
                                        </label>
                                    ...
                                    <div className="flex gap-2 items-center">
                                        <input
                                            ...
                                            onChange={handleChange}
                                            id="origin-transferred-radio"
                                            value="transferred"
                                            type="radio"
                                            className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2"
                                        />
                                        <label
                                            htmlFor="origin-transferred-radio"
                                            className="uppercase"
                                        >
                                            Transferred
                                        </label>
